...
public class JoinAsPlayerValidator : AbstractValidator<JoinAsPlayerModelDTO>
{
    public JoinAsPlayerValidator()
    {
        ...
        RuleFor(x => x.PhoneNumber).NotNull().NotEmpty().WithMessage(ErrorMessages.RequiredField)
